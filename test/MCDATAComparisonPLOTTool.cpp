...
//   gROOT->ProcessLine(toLoad.Data());
 ...
 TTree *treeJetLepVect[41];
  ...
  //  [iCut][iVar] 
 TString* infoString[231][21];
 TLatex *infoLatex[231][21]; 
 TCanvas* ccCanvas[231][21];
 TCanvas* ccCanvasNormalize[231][21];
 TCanvas* ccCanvasPull[231][21];
 TCanvas* ccCanvasVarAndPull[231][21];
 TCanvas* ccCanvasPullTrace[231][21];
 TH1F* histoSumMC[231][21];
 //  [iName][iCut][iVar]
 TH1F* histo[41][231][21];
 TH1F* histo_temp[41][231][21];
 TH1F* histo_temp_over_under[41][231][21];
 
 //  [iName][iCut]
 double numEvents[41][231];
...
//  TPie* hTrendPie[231];
 ...
 THStack* hsSignal[231][41][30];
 THStack* hs[231][41];
 TH1F* hPull[231][41];
 TH1F* hPullTrace[231][41];

 TGraphErrors* grPull[231][41];
 TGraphErrors* grPullMC[231][41];
...
//  cTrendPieAll -> Divide (vCut.size());
 ...
 TCanvas* cCompareCutPull[231];
 TCanvas* cCompareVarPull[41];
 
 TCanvas* cCompareCut[231];
