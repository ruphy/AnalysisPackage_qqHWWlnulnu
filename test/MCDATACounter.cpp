...
//   
 ...
 TTree *treeEffVect[204];
 TTree *treeJetLepVect[204];
 

 
  //  [iCut] 
 TString* infoString[100];
 TLatex *infoLatex[100]; 
 TCanvas* ccCanvas[100];
 TCanvas* ccCanvasPull[100];
 TH1F* histoSumMC[100];
 //  [iName][iCut]
 TH1F* histo[204][100];
 TH1F* histo_temp[204][100];

 //  [iName][iCut]
 double numEvents[204][100];
...
//   std::cout << " | " << std::setw (10) <<  iCut << "::" << vCut.size();
 ...
 ///---- as above but without colors (begin) ----
 std::cout << std::endl;
 std::cout << std::endl;
 std::cout << std::endl;
 std::cout << std::endl;
 ...
 for (unsigned int iName=0; iName<reduced_name_samples.size(); iName++){
  std::cout << std::setw (12) << reduced_name_samples.at(iName) ;
  std::cout << " | " << std::setw (10) <<  numEntriesFirstStep_reduced_samples.at(iName);
  std::cout << " [" << std::setw (10) <<  "XXX";
  std::cout << " ]";
  for (unsigned int iCut = 0; iCut<vCut.size(); iCut++){
   std::cout << " | " << std::setw (10) <<  hTrend[iName]->GetBinContent(iCut+1);
   std::cout << " [" << std::setw (10) <<  hTrend[iName]->GetBinError(iCut+1);
   std::cout << " ]";
  }
  std::cout << std::endl;
 }
 ///---- as above but without colors (end) ----
...
//  myfile << "kmax "<< 15 << " number of nuisance parameters" << std::endl;
 myfile << "kmax "<< 16 << " number of nuisance parameters" << std::endl;
...
//  myfile << "pdf_qqbar                    lnN       1.050      -        -          -       1.030      -        1.060        -      " << std::endl; //              pdfqq        " << std::endl;
 ...
 myfile << "lumi                         lnN       1.040    1.040    1.040      1.040    1.040       -            -        -      " << std::endl; //              Luminosity     " << std::endl;
 myfile << "pdf_gg                       lnN         -      1.080      -        1.080       -        -            -        -      " << std::endl; //              pdfgg        " << std::endl;
 ...
 */
 ...
 myfile << hTrend[numDATA]->GetBinContent(vCut.size()) << std::endl; //---- Observed
...
// //  
 ...
 std::cout << std::endl;
 std::cout  << " \\hline\n" ;
 std::cout  << std::setw (12) << "sample" << " & " << std::setw (10) <<  -1 << " (" << std::setw (10) <<  "XXX" << " )";
 for (unsigned int iCut = 0; iCut < vCut.size () ; iCut++) {
 ...
 //---- samples list
 for (unsigned int iName = 0; iName < reduced_name_samples.size () ; iName++) {
  std::cout  << std::setw (12) << reduced_name_samples.at(iName) << " & " << std::setw (10) << hTrend[iName]->GetBinContent(vCut.size ()) / LUMI * 1000. << " (" << std::setw (10) <<  hTrend[iName]->GetBinError(vCut.size ()) / LUMI * 1000. << " )";
  std::cout << " \\\\" << std::endl;
 }
 std::cout  << " \\hline\n" ;
 std::cout << std::endl;
