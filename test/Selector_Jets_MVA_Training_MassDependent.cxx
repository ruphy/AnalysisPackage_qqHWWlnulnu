...
void Selector_Jets_MVA_Training_MassDependent( TString myMethodList = "" , std::string HiggsMass = "qqH160") {
 ...
 TString outfileName = Form( "output/Selector_Jets_trained_%s.root", HiggsMass.c_str() );
...
//    factory->OptimizeAllMethods("ROCIntegral","Scan");
   ...
   std::string toDo = "mv weights Weights/weights_jet_" + HiggsMass;
