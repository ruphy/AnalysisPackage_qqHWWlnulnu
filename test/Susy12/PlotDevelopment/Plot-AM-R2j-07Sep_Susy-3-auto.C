...
void Plot_AM_R2j_07Sep_Susy_3_auto() {
 TString cutNameBefore = Form("Data/");

 //                            cut_variable 
 TString cutNameAfter  = Form("_3_5_Tot_temp");

 gROOT->LoadMacro("PlotVHqqHggH.C+");
 gInterpreter->ExecuteMacro("LatinoStyle2.C");

 TCanvas* c1 = new TCanvas("R2j","R2j",500,600);
 ...
 c1->Print("07Sep_Susy_3/R2j.pdf");
 c1->Print("07Sep_Susy_3/R2j.png");

 c1->SetLogy();
 hs->Draw(c1,1,true);
 c1->Print("07Sep_Susy_3/R2j_logy.pdf");
 c1->Print("07Sep_Susy_3/R2j_logy.png");
}
