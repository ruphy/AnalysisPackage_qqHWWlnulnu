...
void Plot_AM_detajj_07Sep_Susy_2_auto() {
 TString cutNameBefore = Form("Data/");

 //                            cut_variable 
 TString cutNameAfter  = Form("_2_0_Tot_temp");

 gROOT->LoadMacro("PlotVHqqHggH.C+");
 gInterpreter->ExecuteMacro("LatinoStyle2.C");

 TCanvas* c1 = new TCanvas("detajj","detajj",500,600);
 ...
 c1->Print("07Sep_Susy_2/detajj.pdf");
 c1->Print("07Sep_Susy_2/detajj.png");

 c1->SetLogy();
 hs->Draw(c1,1,true);
 c1->Print("07Sep_Susy_2/detajj_logy.pdf");
 c1->Print("07Sep_Susy_2/detajj_logy.png");
}
