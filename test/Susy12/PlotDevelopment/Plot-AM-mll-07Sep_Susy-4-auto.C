...
void Plot_AM_mll_07Sep_Susy_4_auto() {
 TString cutNameBefore = Form("Data/");

 //                            cut_variable 
 TString cutNameAfter  = Form("_4_2_Tot_temp");
 ...
 c1->Print("07Sep_Susy_4/mll.pdf");
 c1->Print("07Sep_Susy_4/mll.png");

 c1->SetLogy();
 hs->Draw(c1,1,true);
 c1->Print("07Sep_Susy_4/mll_logy.pdf");
 c1->Print("07Sep_Susy_4/mll_logy.png");
}
