...
void Plot_AM_mjj_07Sep_Susy_4_auto() {
 TString cutNameBefore = Form("Data/");

 //                            cut_variable 
 TString cutNameAfter  = Form("_4_1_Tot_temp");
 ...
 c1->Print("07Sep_Susy_4/mjj.pdf");
 c1->Print("07Sep_Susy_4/mjj.png");

 c1->SetLogy();
 hs->Draw(c1,1,true);
 c1->Print("07Sep_Susy_4/mjj_logy.pdf");
 c1->Print("07Sep_Susy_4/mjj_logy.png");
}
