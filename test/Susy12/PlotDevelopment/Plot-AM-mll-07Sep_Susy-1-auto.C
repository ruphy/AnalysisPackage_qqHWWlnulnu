...
void Plot_AM_mll_07Sep_Susy_1_auto() {
 TString cutNameBefore = Form("Data/");

 //                            cut_variable 
 TString cutNameAfter  = Form("_1_2_Tot_temp");
 ...
 c1->Print("07Sep_Susy_1/mll.pdf");
 c1->Print("07Sep_Susy_1/mll.png");

 c1->SetLogy();
 hs->Draw(c1,1,true);
 c1->Print("07Sep_Susy_1/mll_logy.pdf");
 c1->Print("07Sep_Susy_1/mll_logy.png");
}
