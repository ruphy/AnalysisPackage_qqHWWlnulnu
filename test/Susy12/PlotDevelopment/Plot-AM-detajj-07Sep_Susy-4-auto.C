...
void Plot_AM_detajj_07Sep_Susy_4_auto() {
 TString cutNameBefore = Form("Data/");

 //                            cut_variable 
 TString cutNameAfter  = Form("_4_0_Tot_temp");
 ...
 c1->Print("07Sep_Susy_4/detajj.pdf");
 c1->Print("07Sep_Susy_4/detajj.png");

 c1->SetLogy();
 hs->Draw(c1,1,true);
 c1->Print("07Sep_Susy_4/detajj_logy.pdf");
 c1->Print("07Sep_Susy_4/detajj_logy.png");
}
