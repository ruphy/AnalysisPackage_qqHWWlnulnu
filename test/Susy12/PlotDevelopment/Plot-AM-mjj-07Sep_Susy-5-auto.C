...
void Plot_AM_mjj_07Sep_Susy_5_auto() {
 TString cutNameBefore = Form("Data/");

 //                            cut_variable 
 TString cutNameAfter  = Form("_5_1_Tot_temp");
 ...
 c1->Print("07Sep_Susy_5/mjj.pdf");
 c1->Print("07Sep_Susy_5/mjj.png");

 c1->SetLogy();
 hs->Draw(c1,1,true);
 c1->Print("07Sep_Susy_5/mjj_logy.pdf");
 c1->Print("07Sep_Susy_5/mjj_logy.png");
}
