...
void Plot_AM_mll_07Sep_Susy_0_auto() {
 TString cutNameBefore = Form("Data/");

 //                            cut_variable 
 TString cutNameAfter  = Form("_0_2_Tot_temp");
 ...
 c1->Print("07Sep_Susy_0/mll.pdf");
 c1->Print("07Sep_Susy_0/mll.png");

 c1->SetLogy();
 hs->Draw(c1,1,true);
 c1->Print("07Sep_Susy_0/mll_logy.pdf");
 c1->Print("07Sep_Susy_0/mll_logy.png");
}
