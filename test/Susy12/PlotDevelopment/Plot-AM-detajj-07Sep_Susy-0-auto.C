...
void Plot_AM_detajj_07Sep_Susy_0_auto() {
 TString cutNameBefore = Form("Data/");

 //                            cut_variable 
 TString cutNameAfter  = Form("_0_0_Tot_temp");
 ...
 c1->Print("07Sep_Susy_0/detajj.pdf");
 c1->Print("07Sep_Susy_0/detajj.png");

 c1->SetLogy();
 hs->Draw(c1,1,true);
 c1->Print("07Sep_Susy_0/detajj_logy.pdf");
 c1->Print("07Sep_Susy_0/detajj_logy.png");
}
