...
void Plot_AM_MR2j_07Sep_Susy_2_auto() {
 TString cutNameBefore = Form("Data/");

 //                            cut_variable 
 TString cutNameAfter  = Form("_2_3_Tot_temp");
 ...
 c1->Print("07Sep_Susy_2/MR2j.pdf");
 c1->Print("07Sep_Susy_2/MR2j.png");

 c1->SetLogy();
 hs->Draw(c1,1,true);
 c1->Print("07Sep_Susy_2/MR2j_logy.pdf");
 c1->Print("07Sep_Susy_2/MR2j_logy.png");
}
