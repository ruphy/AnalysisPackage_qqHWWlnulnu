...
void Plot_AM_events_07Sep_Susy_4_auto() {
 TString cutNameBefore = Form("Data/");

 //                            cut_variable 
 TString cutNameAfter  = Form("_4_6_Tot_temp");
 ...
 c1->Print("07Sep_Susy_4/events.pdf");
 c1->Print("07Sep_Susy_4/events.png");

 c1->SetLogy();
 hs->Draw(c1,1,true);
 c1->Print("07Sep_Susy_4/events_logy.pdf");
 c1->Print("07Sep_Susy_4/events_logy.png");
}
