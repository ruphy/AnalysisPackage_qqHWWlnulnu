...
void Plot_AM_mjj_07Sep_Susy_3_auto() {
 TString cutNameBefore = Form("Data/");

 //                            cut_variable 
 TString cutNameAfter  = Form("_3_1_Tot_temp");
 ...
 c1->Print("07Sep_Susy_3/mjj.pdf");
 c1->Print("07Sep_Susy_3/mjj.png");

 c1->SetLogy();
 hs->Draw(c1,1,true);
 c1->Print("07Sep_Susy_3/mjj_logy.pdf");
 c1->Print("07Sep_Susy_3/mjj_logy.png");
}
