...
void Plot_AM_mjj_07Sep_Susy_0_auto() {
 TString cutNameBefore = Form("Data/");

 //                            cut_variable 
 TString cutNameAfter  = Form("_0_1_Tot_temp");

 gROOT->LoadMacro("PlotVHqqHggH.C+");
 gInterpreter->ExecuteMacro("LatinoStyle2.C");

 TCanvas* c1 = new TCanvas("mjj","mjj",500,600);
 ...
 c1->Print("07Sep_Susy_0/mjj.pdf");
 c1->Print("07Sep_Susy_0/mjj.png");

 c1->SetLogy();
 hs->Draw(c1,1,true);
 c1->Print("07Sep_Susy_0/mjj_logy.pdf");
 c1->Print("07Sep_Susy_0/mjj_logy.png");
}
