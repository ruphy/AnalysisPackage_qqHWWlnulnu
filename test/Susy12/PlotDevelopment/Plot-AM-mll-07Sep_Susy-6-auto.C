...
void Plot_AM_mll_07Sep_Susy_6_auto() {
 TString cutNameBefore = Form("Data/");

 //                            cut_variable 
 TString cutNameAfter  = Form("_6_2_Tot_temp");
 ...
 c1->Print("07Sep_Susy_6/mll.pdf");
 c1->Print("07Sep_Susy_6/mll.png");

 c1->SetLogy();
 hs->Draw(c1,1,true);
 c1->Print("07Sep_Susy_6/mll_logy.pdf");
 c1->Print("07Sep_Susy_6/mll_logy.png");
}
