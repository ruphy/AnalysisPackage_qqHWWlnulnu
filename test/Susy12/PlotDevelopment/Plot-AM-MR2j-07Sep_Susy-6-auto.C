...
void Plot_AM_MR2j_07Sep_Susy_6_auto() {
 TString cutNameBefore = Form("Data/");

 //                            cut_variable 
 TString cutNameAfter  = Form("_6_3_Tot_temp");
 ...
 c1->Print("07Sep_Susy_6/MR2j.pdf");
 c1->Print("07Sep_Susy_6/MR2j.png");

 c1->SetLogy();
 hs->Draw(c1,1,true);
 c1->Print("07Sep_Susy_6/MR2j_logy.pdf");
 c1->Print("07Sep_Susy_6/MR2j_logy.png");
}
