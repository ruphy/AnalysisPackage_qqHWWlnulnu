...
void Plot_AM_MTR2j_07Sep_Susy_1_auto() {
 TString cutNameBefore = Form("Data/");

 //                            cut_variable 
 TString cutNameAfter  = Form("_1_4_Tot_temp");
 ...
 c1->Print("07Sep_Susy_1/MTR2j.pdf");
 c1->Print("07Sep_Susy_1/MTR2j.png");

 c1->SetLogy();
 hs->Draw(c1,1,true);
 c1->Print("07Sep_Susy_1/MTR2j_logy.pdf");
 c1->Print("07Sep_Susy_1/MTR2j_logy.png");
}
