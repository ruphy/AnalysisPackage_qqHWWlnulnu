...
int main(int argc, char** argv) {
 ...
 for (int iSample=0; iSample<numberOfSamples; iSample++){ 
  ...
  treeJetLepVect[iSample] -> SetBranchAddress("boostedDphill_130", &boostedDphill_130);
...
//    TMVAreader->AddVariable("dphill",       &input_variables[8]);
   TMVAreader->AddVariable("boostedDphill_130",       &input_variables[8]);   
   ...
   TMVAreader->AddVariable("drll",         &input_variables[13]);
   ...
   for (int iSample=0; iSample<numberOfSamples; iSample++){ 
    ...
    TString methodName4Tree2 =  Form ("%s_%s_MVAHiggs_VH/D",myMethodList.Data(),myMethodMassList.Data());
...
//      input_variables[8]  = static_cast<Float_t>(dphill);
     input_variables[8]  = static_cast<Float_t>(boostedDphill_130);
