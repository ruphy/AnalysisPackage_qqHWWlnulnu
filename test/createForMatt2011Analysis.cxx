...
void createForMatt2011Analysis(){
 //  
...
//  Double_t x_vals[40] = {110, 115, 118, 120, 122, 124, 126, 128, 130, 135, 140, 150, 160, 170, 180, 190, 200, 250, 300, 350, 400, 450, 500, 550, 600};
 ...
 for (int iMass = 0; iMass<nMass; iMass++) {
  ...
  myfileTop << x_vals[iMass] << "   " << ValueTop.at(iMass)  << "   " << ValueTop.at(iMass)*(SystTop.at(iMass)-1) << std::endl;
 ...
 for (int iMass = 0; iMass<nMass; iMass++) {
  ...
  myfileDY << x_vals[iMass] << "   " << ValueDY.at(iMass)  << "   " << ValueDY.at(iMass)*(SystDY.at(iMass)-1) << std::endl;
...
//  std::cout << "cp DYCard_2j.txt   ~/Dropbox/Public/VBF/2011Dec05" << std::endl;
 ...
 std::cout << "mkdir  ~/Dropbox/Public/VBF/2012Apr04" << std::endl; 
 std::cout << std::endl;
 std::cout << "cp TopCard_2j.txt  ~/Dropbox/Public/VBF/2012Apr04/" << std::endl; 
 std::cout << "cp DYCard_2j.txt   ~/Dropbox/Public/VBF/2012Apr04/" << std::endl;
